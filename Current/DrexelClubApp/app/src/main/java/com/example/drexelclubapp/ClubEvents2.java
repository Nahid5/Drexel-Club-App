...
public class ClubEvents2 extends AppCompatActivity implements AdapterView.OnItemClickListener{
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_club_events2);

        ListView listView = (ListView) findViewById(R.id.lvevents2);

        // Create and populate a List of club events.
        String[] events = new String[] { "Trivia & Bingo", "Event2", "Event3", "Event4",
    ...
    public void onItemClick(AdapterView<?> l, View view, int position, long id) {
        if(position==0) {
            Intent i = new Intent(ClubEvents2.this, eventdetails.class);
            startActivity(i);
        }
    }
}
