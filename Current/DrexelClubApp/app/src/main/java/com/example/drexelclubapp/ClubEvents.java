...
public class ClubEvents extends AppCompatActivity implements AdapterView.OnItemClickListener{
/**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] events = new String[] { "Trivia & Bingo", "Rogue One: A Star Wars Story", "Event3", "Event4",
    ...
    public void onItemClick(AdapterView<?> l, View view, int position, long id) {
        if(position==0) {
            Intent i = new Intent(ClubEvents.this, eventdetails.class);
            startActivity(i);
        }
        if(position==1) {
            Intent i = new Intent(ClubEvents.this, eventdetails2.class);
            startActivity(i);
        }
    }
}
