...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        GoToNewActivity1 = (Button)findViewById(R.id.BLogin);
        GotoNewActivity2 = (TextView)findViewById(R.id.tvRegister);

        GoToNewActivity1.setOnClickListener(new OnClickListener() {
        ...
        GotoNewActivity2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
